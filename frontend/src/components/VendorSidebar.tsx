...
export default function VendorSidebar() {
  ...
  const menuUtama = [
    ...
    { name: 'KATALOG JASA', path: '/dashboard/katalog', icon: BoxIcon },
    { name: 'PESANAN & JADWAL', path: '/dashboard/jadwal', icon: CalendarIcon },
    { name: 'KEUANGAN', path: '/dashboard/keuangan', icon: WalletIcon },
  ];

  const personal = [
    { name: 'PROFIL STUDIO', path: '/dashboard/profil', icon: UserIcon },
      ...
      <aside className="w-[280px] bg-white border-r border-gray-100 flex flex-col h-full flex-shrink-0 z-20">
              ...
              return (
                <Link
                  ...
                  className={`flex items-center gap-3 px-4 py-3.5 rounded-2xl transition-colors group ${
                    isActive ? 'bg-[#FCE6E3]' : 'hover:bg-gray-50'
                  }`}
                >
        ...
        <div className="p-6 mt-auto">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-[#FDF1F0] to-[#FAFAFC] border border-[#FDECEB] hover:border-[#FCE6E3] py-3.5 rounded-2xl transition-all group"
          >
