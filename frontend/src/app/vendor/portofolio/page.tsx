              ...
              {filteredPortfolio.map((item) => (
                ...
                >
                  <div className="relative h-44 overflow-hidden">
                    <img src={item.image || 'https://images.unsplash.com/photo-1519741497674-611481863552?auto=format&fit=crop&q=80'} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" alt={item.title} />
