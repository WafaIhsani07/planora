      ...
      <div className="relative hidden lg:flex lg:w-1/2 flex-col p-16 xl:p-24 justify-between overflow-hidden">
        ...
        <div className="relative z-20 mt-10">
          ...
          <p className="text-slate-700 font-bold text-lg max-w-md leading-relaxed opacity-85">
            {role === 'customer'
              ? 'Daftar sebagai customer untuk mulai merencanakan momen impian Anda dengan vendor terbaik.'
        ...
        <div className="relative z-20 mt-auto space-y-8">
          ...
          <div className="max-w-md border-l-4 border-[#FF527B] pl-6">
            <p className="text-lg xl:text-xl font-black text-black leading-snug italic opacity-90">
              "Ngurus acara jadi jauh lebih tenang dan teratur. Bener-bener ngebantu banget!"
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-[500px] py-8 md:py-10">
          <div className="mb-10">
            ...
            <h2 className="text-3xl md:text-[2rem] font-extrabold text-[#0D121F] mb-3 tracking-tight leading-tight">
              Daftar ke <span className="text-[#FF9A9E]">Planora</span>
            </h2>
            <p className="text-slate-400 text-sm font-medium">
              Sudah punya akun?{' '}
              <Link href="/login" className="text-[#FF9A9E] font-bold hover:underline">
                Masuk Sekarang
              </Link>
            </p>
          </div>
          ...
          <div className="flex bg-[#F7F9FC] p-1.5 rounded-2xl mb-10 border border-slate-100">
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-3 py-3.5 rounded-xl font-bold text-sm transition-all duration-300 ${
                role === 'customer' ? 'bg-[#FFDED7] text-black shadow-sm' : 'text-slate-400 hover:text-slate-500'
              }`}
            >
              <User className={`w-5 h-5 ${role === 'customer' ? 'text-black' : 'text-slate-400'}`} />
              Customer
            </button>
            <button
              type="button"
              ...
              className={`flex-1 flex items-center justify-center gap-3 py-3.5 rounded-xl font-bold text-sm transition-all duration-300 ${
                role === 'vendor' ? 'bg-[#FFDED7] text-black shadow-sm' : 'text-slate-400 hover:text-slate-500'
              }`}
            >
              <UserCircle className={`w-5 h-5 ${role === 'vendor' ? 'text-black' : 'text-slate-400'}`} />
              Vendor
            </button>
          </div>
          ...
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="flex items-start gap-3 px-1 py-2">
              ...
              <label htmlFor="agree" className="text-sm font-bold text-slate-500 cursor-pointer select-none leading-tight">
                Saya menyetujui <button className="text-[#FF9A9E] hover:underline transition-all">Syarat & Ketentuan</button> serta <button className="text-[#FF9A9E] hover:underline transition-all">Kebijakan Planora</button>.
              </label>
            </div>
          ...
          <div className="flex items-center gap-4 bg-[#FF9A9E]/5 p-5 rounded-[24px] border border-[#FF9A9E]/10">
            ...
            <p className="text-[10px] text-slate-400 leading-relaxed font-bold">
              Data pendaftaran Anda aman. Kami menjamin kerahasiaan informasi sesuai standar keamanan global Planora.
            </p>
          </div>
        </div>
      </div>
