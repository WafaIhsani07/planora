        ...
        <section className="relative hidden overflow-hidden lg:flex lg:flex-col lg:justify-between lg:p-16 xl:p-24">
          ...
          <div className="relative z-10 max-w-xl">
            ...
            <h1 className="text-5xl font-black leading-[1.05] tracking-tight text-black xl:text-6xl">
              Forgot password?
              <br />
              <span className="text-[#FF527B] italic drop-shadow-md">Get back in safely</span>
            </h1>
            <p className="mt-6 max-w-lg text-lg font-bold leading-relaxed text-slate-700 opacity-90">
              Send a reset link to your registered email. We will help you get back into your vendor dashboard quickly.
            </p>
          </div>
          ...
          <div className="relative z-10 space-y-6">
            <div className="max-w-md border-l-4 border-[#FF527B] pl-6">
              <p className="text-xl font-black leading-snug italic text-black opacity-90">
                "Account access remains secure, and the reset flow is designed simply so the vendor team can get back to work immediately."
              </p>
            </div>
            <div className="flex items-center gap-4 text-sm font-bold text-slate-700">
              ...
              Centralized account protection and recovery for vendor access.
            </div>
          </div>
        </section>
          ...
          <div className="relative z-10 w-full max-w-[520px] rounded-[32px] border border-[#F1D8D4] bg-white p-6 shadow-[0_20px_60px_rgba(15,23,42,0.08)] sm:p-8 lg:p-10">
            ...
            <div className="mb-8 space-y-3">
              ...
              <p className="max-w-lg text-sm leading-7 text-slate-500 sm:text-base">
                We will send a password reset link to the email registered for your vendor account.
              </p>
            </div>
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              <div className="rounded-2xl border border-[#F2E4E2] bg-[#FFF9F8] p-4">
                <p className="text-xs font-black uppercase tracking-[0.2em] text-[#FF527B]">Step 1</p>
                <p className="mt-2 text-sm font-semibold leading-6 text-slate-600">Enter the active vendor email for your Planora account.</p>
              </div>
              <div className="rounded-2xl border border-[#F2E4E2] bg-[#FFF9F8] p-4">
                <p className="text-xs font-black uppercase tracking-[0.2em] text-[#FF527B]">Step 2</p>
                <p className="mt-2 text-sm font-semibold leading-6 text-slate-600">Open the email, click the reset link, and create a new password.</p>
              </div>
            </div>
          </div>
        </section>
